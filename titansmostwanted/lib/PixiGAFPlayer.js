...
/*
		textFormat.dropShadow = true;
		textFormat.dropShadowBlur = 2;
		textFormat.dropShadowDistance = 0;
		textFormat.strokeThickness = 1;
		//textFormat.stroke = 'white';
*/
...
var com_github_haxePixiGAF_display_GAFTextField = $hx_exports["GAF"]["GAFTextField"] = function(config,scale,csf,debug) {
	...
	//config.get_textFormat()._width = 100;

	this.textField = new PIXI.Text(config.get_text(),config.get_textFormat());

	//console.log(config.get_text(), config.get_width(), config);
	...
	if(config.get_textFormat().align == "center") {
		...
		//console.log("right pivot", config.get_text(), config);
	}


	//console.log("please", config._pivotPoint);
	...
	if(debug) {
		...
		if(config.get_textFormat().align == "left") {
			...
			//console.log(config._pivotPoint.x, config._pivotPoint.y);
		}
