function cyborg_clone_path(trg){
...
function cyborg_clone_fire_bullet(trg){
	...
	all.pieces.attachMovie('cyborg_clone_beam','bullet'+bullet_lev,pieces_lev+5000);
	...
	bullet_trg.onEnterFrame = function(){
		bullet_ai(bullet_trg,trg.damage,100,38);
	}
...
function cyborg_clone_movement_ai(trg){
	// centres
	trg.centre_x = trg._x;
...
function cyborg_clone_animation(trg){
