AG.Pause = function(soul) {
    ...
    this.addChild(this.back = new AG.Back(soul, '50_back_pause', null));
    ...
    this.addFrame(this.b_menu = new AG.ImgButton('b_menu', 'b_shadow', 1.1, this, S, this.W *.5, this.H *soundDY));
    ...
    addEvent(this.b_menu, AG.ImgButton.CLICK, this.h_buttons);
...
pro.h_mouse = function(e) {
    if(e.type == GodStep.FRAME_UP) {
        if(e.content.target) {
            if(e.content.target.soul) {
                var t = e.content.target;
                t.b_sound_on.isDown = t.b_sound_off.isDown = t.b_music_on.isDown =t.b_music_off.isDown = t.b_menu.isDown = t.b_clear.isDown = t.b_back.isDown = false;
                t.b_sound_on.Scale = t.b_sound_off.Scale = t.b_music_on.Scale =t.b_music_off.Scale = t.b_menu.Scale = t.b_clear.Scale = t.b_back.Scale = 1;
            }
        }
    }
...
pro.h_buttons = function(e) {
    ...
    switch (t) {
        ...
        case p.b_menu:
            GodStep.playSound('button', 0, AG.SOUND);
            p.soul.screenTo([p.soul.startmenu], p.parent);
            if(p.soul.AUDIOTAG) {
...
Object.defineProperty(pro, 'Scale', {
    ...
    set: function(value) {
        ...
        this.back.y = -(this.soul.OH - this.soul.H)/2/value;
