...
var GodStep = GS = GodStep || {}; var GodPath = GodPath || '';  GodStep.ver = 1; var pro; GodStep.includes = []; GodStep.SCALE = 1;
    GodStep.STARTTIME = new Date().getTime();
 //   GodStep.STARTTIME = 1;
    GodStep.version = '4.3.8';
...
include('lq/video/IHTML430');    //\\ | | | | | | | | |  //\\
include('lq/video/EventTarget');   //\\//\\//\\//\\//\\//\\//\\
include('lq/video/IOverOut');   //\\//\\//\\//\\//\\//\\//\\
include('lq/video/IDownUp430');   //\\//\\//\\//\\//\\//\\//\\
include('lq/video/IDragDrop');  //\\//\\//\\//\\//\\//\\//\\
         ...
         function extend(child, parent) {
             ...
             return pro = child.prototype = Object.create(parent.prototype);
         }
         ...
         function include(path) {
             if(!GodStep.includes[path]) {
                 ...
                 document.write("<script src=" + GodPath + path + ".js?" + GodStep.STARTTIME + " type='text/javascript' charset='utf-8'></script>");
         ...
         function override(object, name, body) {
             Object.defineProperty(object.prototype, name, body);
                             ...
                             (function(){
                                 ...
                                 PIXI.EventTarget.call(this); //430
                                ...
                                if(this.div) { trace("[" + GodStep.version +
                                    ...
                                    // opt.resolution = .5;
                                    if(this.WEBGL) {
                                        this.webgl = renderer = new PIXI.WebGLRenderer  ( this.W, this.H, opt );
                                        this.div.appendChild(this.soulview = this.webgl.view); }
                                    else
                                    if(this.CANVAS) {
                                        this.canvas = renderer = new PIXI.CanvasRenderer ( this.W, this.H, opt);
                                        this.canvas.view.style.display = 'block';

                                        this.div.appendChild(this.soulview = this.canvas.view);  GodStep.Mejdu.C =this.canvas;
                                    } else {
                                        renderer = PIXI.autoDetectRenderer(this.W, this.H, opt);
                                     ...
                                     if(GodStep.COLOR_STAGE) {
                                         this.stage = new PIXI.Container(GodStep.COLOR_STAGE);
                                     } else {
                                    ...
                                    GS.MAX_TEXTURE_SIZE = this.renderer.gl.getParameter(this.renderer.gl.MAX_TEXTURE_SIZE)/4;
                                     ...
                                     if(!GodStep.Mejdu.TESTCANVAS) {
                                         ...
                                         GodStep.TESTCTX_RT = PIXI.RenderTexture.create(1, 1);
                                         GodStep.TESTCTX_IMG = new PIXI.Sprite(GodStep.TESTCTX_RT);
                                         GodStep.TESTCTX_C = new PIXI.Container();
                                   ...
                                   //this.div.style.left = this.div.style.top = '0px';
                                    this.start();
                                     GodStep.Mejdu.render() ; window.requestAnimationFrame( GodStep.Mejdu.update );
                                 };
                                    ...
                                    GodStep.Mejdu.pro.addFrameAt = function(frame, at, container) {
                                         if(container) {
                                             container.addChildAt(frame, at);
                                         } else {
                                             this.stage.addChildAt(frame, at);
                                         }
                                    ...
                                    GodStep.Mejdu.pro.createTempCanvas = function(w, h) {
                                        if(!GodStep.TEMPCANVAS) {
                                            ...
                                            this.stage.addChild(GodStep.TEMPCONTAINER = new PIXI.Container());
                                        }
                                    };
                              ...
                              GodStep.Mejdu.update = function() {
                                  ...
                                  if(GodStep.FrameRate) {
                                      ...
                                      window.requestAnimationFrame( GodStep.Mejdu.update );
                                  }
                              ...
                              GodStep.Mejdu.render = function() {
                                  ...
                                  window.requestAnimationFrame( GodStep.Mejdu.render );
                              };
