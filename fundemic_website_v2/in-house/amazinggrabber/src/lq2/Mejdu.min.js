...
var GS;var GodStep=GS=GodStep||{};var GodPath=GodPath||'';GodStep.ver=1;var pro;GodStep.includes=[];GodStep.SCALE=1;GodStep.version='1.1.7';GodStep.UPDATE_LAG=0;GodStep.DIVBYCLASS=false;GodStep.UPDATE_TIME_LAST=GodStep.UPDATE_TIME=new Date().getTime();GodStep.UPDATE_DELAY_COEF_INV=1;(function(){var root=this;var PIXI=PIXI||{};PIXI.WEBGL_RENDERER=0;PIXI.CANVAS_RENDERER=1;PIXI.VERSION="v2.2.7";PIXI.blendModes={NORMAL:0,ADD:1,MULTIPLY:2,SCREEN:3,OVERLAY:4,DARKEN:5,LIGHTEN:6,COLOR_DODGE:7,COLOR_BURN:8,HARD_LIGHT:9,SOFT_LIGHT:10,DIFFERENCE:11,EXCLUSION:12,HUE:13,SATURATION:14,COLOR:15,LUMINOSITY:16};PIXI.scaleModes={DEFAULT:0,LINEAR:0,NEAREST:1};PIXI._UID=0;if(typeof(Float32Array)!='undefined')
...
if(isOk){var s=createjs.Sound.play(name,createjs.Sound.PLAY_SUCCEEDED,0,0,repeatCount,1,1);s.superName=name;s.superRepeat=repeatCount;if(GodStep.Game.AUDIOEVENT){addEvent(s,'loop',GodStep.loopEvent);}}}}else{trace('not available');}};GodStep.loopEvent=function(e){var WS=e.target;createjs.Sound.stop();delEvent(WS,'loop',GodStep.loopEvent);GodStep.playSound(WS.superName,WS.superRepeat,true);};GodStep.PIXIEvent=PIXI.Event;PIXI.Event=function(target,name,data){GodStep.PIXIEvent.call(this,target,name,data);this.stopped=true;};