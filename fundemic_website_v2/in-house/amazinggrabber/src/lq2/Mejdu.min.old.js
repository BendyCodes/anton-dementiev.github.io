...
window.requestAnimFrame(GodStep.Mejdu.render);};var Games=Games||{};Games.SCALE=1;Games.FRAME_RATE=1/60;GodStep.Game=function(n,color,preloaderClass,setting_slot,player_slot,defaultSettings,type,w,h){this.ANTIALIAS=true;GodStep.PAUSE=false;GodStep.Game.AUDIOEVENT=false;GodStep.IMAGE_RESOLUTION=GodStep.IMAGE_RESOLUTION||1;this.TRANSPARENT=GodStep.Game.TRANSPARENT;this.FULLPAGE=GodStep.Game.FULLPAGE;GodStep.Game.MUTED=false;switch(type){case'auto':break;case'canvas':this.CANVAS=true;break;case'webgl':this.WEBGL=true;break;}
