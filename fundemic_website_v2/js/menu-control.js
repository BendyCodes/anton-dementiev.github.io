...
let header__button = document.getElementById("animated-button-header-1");
let footer__button = document.getElementById("animated-button-footer-1");

// Snap(header__button);
// Snap(footer__button);

let header1 = Snap.select('#visible-header-1');
let header2 = Snap.select('#visible-header-2');
let footer1 = Snap.select('#visible-footer-1');
let footer2 = Snap.select('#visible-footer-2');
...
header__button.addEventListener('mouseenter', function () {
  header1.animate({d: invisible_d}, 400, mina.backout);
  header2.animate({d: invisible_d}, 400, mina.backout);
});

header__button.addEventListener('mouseleave', function () {
  header1.animate({d: visible_d}, 400, mina.backout);
  header2.animate({d: visible_d}, 400, mina.backout);
});

footer__button.addEventListener('mouseenter', function () {
  footer1.animate({d: invisible_d}, 400, mina.backout);
  footer2.animate({d: invisible_d}, 400, mina.backout);
});

footer__button.addEventListener('mouseleave', function () {
  footer1.animate({d: visible_d}, 400, mina.backout);
  footer2.animate({d: visible_d}, 400, mina.backout);
});
